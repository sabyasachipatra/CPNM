...
doref(graph *g, int *lab, int *ptn, int level, int *numcells,
      ...
      void (*refproc)(graph*, int*, int*, int, int*, permutation*, set*, int*,
      int, int), void (*invarproc)(graph*, int*, int*, int, int, int,
      permutation*, int, boolean, int, int), int mininvarlev, int maxinvarlev,
      int invararg, boolean digraph, int m, int n) {
    int j, h;
    permutation pw;
    int iw;
    ...
    if (invarproc != NULL && *numcells < n
        ...
        (*invarproc)(g, lab, ptn, level, *numcells, tvpos, invar,
...
maketargetcell(graph *g, int *lab, int *ptn, int level, set *tcell,
               ...
               int hint, int (*targetcell)(graph*, int*, int*, int, int,
               boolean, int, int, int), int m, int n) {
    int i, j, k;
...
void
breakout(int *lab, int *ptn, int level, int tc, int tv, set *active, int m) {
    int i, prev, next;
